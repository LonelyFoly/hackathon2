...
namespace Ya_ustal
{
	class methods
	{
		...
		public void Request1(string companyName)
		{
			//столбец 1
		...
		public void Request2(string companyName)
		{
			//столбец 1
			IList<IList<object>> CompanyNames = ReadEntries(sheets[1], SpreadsheetID, $"!B2:B{action_count + 1}");
			//столбец 9
		...
		public void Request3(string ionName, string isotope, string sessionNumber)
		{
		...
		public void Request4(string ionName)
		{
		...
		public void Request5(string ionName)
		{
		...
		public void fillSystemsheet1(string pressure, string vlazh, string temp)
		{
		...
		public void fillSystemsheet2(string iontype, string prot)
		{
		...
		public void fillIonInfo(string d1, string d2, string d3, string d4,
...
"", t2, t3, t4, t5, t6, "", t7, t8, t9};
		...
		public void fillDataSmena(string d0, string d1, string d2, string d3, string d4,
string d5, string d7, string d8, string d9, string d10,
string d11, string d12, string d13, string d14,
string d15, string d16, string d17, string d18,
...
"", t2, t3, t4, t5, t6, "", t7, t8, t9};
		...
		public void fillDataPerehod(string d0, string d1, string d2, string d3, string d4,
string d5, string d6, string d7, string d8, string d9, string d10,
string d11, string d12, string d13, string d14,
string d15, string d16, string d17, string d18,
string d19, string d20, string d21, string d22,
...
"", t2, t3, t4, t5, t6, "", t7, t8, t9};
		...
		//end new
		public void GenPDFSeances(string action_interval)
		{
			System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
			...
			foreach (int cur_seance in row_num)
			{
				...
				doc.Save($"../../../gennedPDF/Test{actual_index + 1}.pdf"); //путь, куда сохранять док
		...
		public void GenPDFTransitions(string action_interval)
		{
			System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
			List<int> row_num = new List<int>();
			IList<IList<object>> Search_index_list = ReadEntries(sheets[0], SpreadsheetID, $"!A3:A{action_count}"); //столбец с номерами
			...
			foreach (int cur_seance in row_num)
			{
				...
				doc.Save($"../../../gennedPDF/TestTransit{actual_index + 1}.pdf"); //путь, куда сохранять док
